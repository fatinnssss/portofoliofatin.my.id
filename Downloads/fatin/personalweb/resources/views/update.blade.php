  ...
  <div class="flex min-h-screen flex-row">
    <div class="relative flex flex-col bg-clip-border rounded-xl bg-slate-500 text-white h-[calc(100vh-2rem)] w-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5 mt-4">
        <div class="mb-2 p-4 text-center bg-slate-700 rounded-xl">
          <h1 class="font-semibold text-2xl"><span class="text-[#E4842C]">Fatin</span> Dashboard!</h1>
        </div>
      ...
      <main class="main -ml-48 flex flex-grow flex-col p-4 transition-all duration-150 ease-in md:ml-0">
        <div class="block h-full text-white font-bold shadow-md rounded-xl justify-between">
          <h1 class="text-3xl px-3 pt-4 text-black">Fatin Dashboard!</h1>

          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="ml-3 h2 text-xl px-3 py-1 rounded-lg bg-slate-700 text-center">UPDATE</h1>
          </div>
